...
class Magik_Civicsettings_Block_Adminhtml_System_Config_Form_Field_Font extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= '<br/><div id="civicsettings_gfont_preview" style="font-size:20px; margin-top:5px;">Lorem Ipsum is simply dummy text</div>
		<script>
        ...
        googleFontPreviewModel.prototype = {
            initialize : function()
            {
                this.fontElement = $("civicsettings_civicsettings_appearance_font");
                this.previewElement = $("civicsettings_gfont_preview");
                this.loadedFonts = "";
